...
(function($PS) {
  ...
  var runCommand = function (v) {
      return Effect_Aff.makeAff(function (cb) {
          return function __do() {
              ...
              Node_ChildProcess.onExit(cp)(function (v1) {
  ...
  var mkJSONError = function ($93) {
      return JSONError.create(Simple_JSON_Utils.printMultipleErrors($93));
  };
  var readPackage = (function () {
      var $94 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(mkJSONError);
  ...
  var readForeignFetchResult = new Simple_JSON.ReadForeign((function () {
      var $97 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Kishimen.variantToGenericSum(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $98 = Simple_JSON.readImpl(Simple_JSON.readForeignVariant()(Simple_JSON.readVariantCons(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
  ...
  var writeForeignFetchResult = new Simple_JSON.WriteForeign((function () {
      var $100 = Simple_JSON.writeImpl(Simple_JSON.writeForeignVariant()(Simple_JSON.consWriteForeignVariant(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $101 = Kishimen.genericSumToVariant(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      }))()(Kishimen.genericSumToVariantArgArguments))(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "Fetched";
      }))()(Kishimen.genericSumToVariantArgArguments))()()()()(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var exit = (function () {
      var $103 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
      return function ($104) {
          return $103($foreign["_exit"]($104));
      };
  })();
  ...
  var generate = (function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(ensureSetup)(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(exitOnError(spagoListPackages))(function (packages) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(toResult)(Control_Parallel.parTraverse(Effect_Aff.parallelAff)(Data_Traversable.traversableArray)(ensureFetchPackage)(packages)))(function (fetches) {
                  if (fetches instanceof Data_Either.Left) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("errors from fetching packages:"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableArray)((function () {
                              var $55 = Effect_Class_Console.error(Effect_Aff.monadEffectAff);
                              var $56 = Data_Show.show(Core.showMyError);
                              return function ($57) {
                                  return $55($56($57));
                              };
...
(function($PS) {
  ...
  var help = "spago2nix - generate Nix derivations from packages required in a spago project, and allow for installing them and building them.\x0a\x0a  Usage: spago2nix (generate | install | build)\x0a\x0aAvailable commands:\x0a  generate\x0a    Generate a Nix expression of packages from Spago\x0a  install [passthrough args for nix-shell]\x0a    Install dependencies from spago-packages.nix in Spago style\x0a  build [passthrough args for nix-shell]\x0a    Build the project Spago style\x0a  build-nix [passthrough args for nix-shell]\x0a    Build the project using dependency sources from Nix store\x0a";
  var build = function (buildStyle) {
      return function (extraArgs) {
          var buildStyleAttr = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 65, column 22 - line 67, column 38): " + [ buildStyle.constructor.name ]);
          })();
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Core.buildScript(Data_List_Types.foldableList)({
              attr: buildStyleAttr,
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Control_Alt.alt(Effect_Aff.altAff)(Core.runDhallToJSON("(./spago.dhall).sources"))(Control_Applicative.pure(Effect_Aff.applicativeAff)("")))(function (json) {
                  return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                      ...
                      throw new Error("Failed pattern match at Main (line 51, column 12 - line 59, column 14): " + [ v.constructor.name ]);
                  })())(function (globs) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Core.runCommand({
                          cmd: "bash",
                          args: Data_Semigroup.append(Data_Semigroup.semigroupArray)([ ".spago2nix/build" ])(globs)
                      }))(function () {
